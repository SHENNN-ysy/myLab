...
public class FileController {
     ...
     * 上传文件到指定目录，返回文件元信息。
     *
     * @param directory 目标目录，仅支持 footstep、hero、hobbies、icon、mylab-post、mylab
     */
    @PostMapping("/upload")
    @Operation(summary = "上传资源", description = "directory 支持 footstep、hero、hobbies、icon、mylab-post、mylab，且只允许图片。")
