...
VALUES
    ...
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:skill-csharp-dotnet'), '/assets/tech-stack-icons/csharp-dotnet.png', 'local', 'csharp-dotnet.png', 'image/png', 0),
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:skill-java-spring-boot'), '/assets/tech-stack-icons/java-spring-boot.png', 'local', 'java-spring-boot.png', 'image/png', 0),
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:skill-docker'), '/assets/tech-stack-icons/docker.png', 'local', 'docker.png', 'image/png', 0),
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:skill-sql'), '/assets/tech-stack-icons/sql.png', 'local', 'sql.png', 'image/png', 0),
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:skill-javascript-typescript'), '/assets/tech-stack-icons/javascript-typescript.png', 'local', 'javascript-typescript.png', 'image/png', 0),
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:skill-react-vue'), '/assets/tech-stack-icons/react-vue.png', 'local', 'react-vue.png', 'image/png', 0),
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:skill-python'), '/assets/tech-stack-icons/python.png', 'local', 'python.png', 'image/png', 0),
    (uuid_generate_v5(uuid_ns_url(), 'myblog:resource:hobby-counter-strike-2'), '/game_posters/cs2.jpg', 'local', 'cs2.jpg', 'image/jpeg', 0),
