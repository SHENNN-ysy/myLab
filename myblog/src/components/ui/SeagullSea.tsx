...
import styles from './SeagullSea.module.css'
...
export function SeagullSea({ descClass, panelClass }: { descClass: string; panelClass: string }) {
  ...
  useEffect(() => {
    ...
    function alignHorizon(cv: HTMLCanvasElement) {
  ...
  return <canvas ref={canvasRef} className={styles['seagull-sea']} aria-hidden="true" />
}
